results_combined = open('reads_Directory.tex', 'w')

results = {}

input_FDS = ['reads_label_Directory.dat', 
'reads_latency_Directory.dat', 
'reads_retreive_vds_Directory.dat',
'reads_fromdisk_Directory.dat', 
'reads_download_indi_Directory.dat',
'reads_decrypt_Directory.dat']
