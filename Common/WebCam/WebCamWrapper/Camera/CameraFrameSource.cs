...
using HomeOS.Hub.Common.WebCam.WebCamWrapper.Camera.Configuration;
using HomeOS.Hub.Common.WebCam.WebCamWrapper.Contracts;

namespace HomeOS.Hub.Common.WebCam.WebCamWrapper.Camera
{
