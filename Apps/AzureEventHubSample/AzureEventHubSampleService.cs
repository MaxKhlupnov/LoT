...
namespace HomeOS.Hub.Apps.AzureEventHubSample
{
    ...
    public class SensorAppService : IDigitalMediaContract
    {
        protected VLogger logger;
        SensorApp SensorInfo;

        public SensorAppService(VLogger logger, SensorApp SensorStuff)
        {
            this.logger = logger;
        ...
        public List<string> SetDigitalSignal(int slot, int join, string value)
        {
            ...
            try
            {
                retVal = this.SensorInfo.SetDigitalSignal(slot, join, value);
            }
            catch (Exception e)
            {
        ...
        public List<string> GetReceivedMessages()
        {
            ...
            try
            {
                retVal = this.SensorInfo.GetReceivedMessages();
            }
            catch (Exception e)
            {
